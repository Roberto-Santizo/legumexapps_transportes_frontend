...
import { DEPARTURE_POINT_MAP_DEFAULT_CENTER, DEPARTURE_POINT_MAP_DEFAULT_ZOOM, DEPARTURE_POINT_MAP_PIN_ZOOM } from "@/features/departure-points/departure-points";
...
type Props = {
    children?: ReactNode;
    /** Encuadre inicial. Si el punto de partida todavía no tiene pin, abre sobre Guatemala. */
...
export function DeparturePointMapCanvas({ children, center, height = "h-[22rem]", readOnly = false, onClick }: Props) {
    ...
    const camera = center
        ? { defaultCenter: center, defaultZoom: DEPARTURE_POINT_MAP_PIN_ZOOM }
        : { defaultCenter: DEPARTURE_POINT_MAP_DEFAULT_CENTER, defaultZoom: DEPARTURE_POINT_MAP_DEFAULT_ZOOM };
