 ...
 *
 * Es una sola caja porque el backend busca en el código y en el nombre a la
 * vez: partirla en dos prometería una precisión que la API no da. En blanco se
 * ignora y devuelve el catálogo completo.
 */
...
export function ClientSearchBar({ search, setSearchParams }: Props) {
            ...
            <label className="flex flex-col gap-2">
                ...
                <span className="relative w-full sm:w-[22rem]">
                    ...
                    <input
                        ...
                        placeholder="CLI-001, Agroexportadora"
